...
正式 token、主题、共享 CSS、参考导出及文档站预览同步；冻结候选与历史验收保留。品牌主色与 SVG Logo、字体、间距、圆角、布局、组件 API、业务规则不变。详见 [决策记录](docs/design/08-governance/08-component-color-convergence.md)。
