...
当前色彩与品牌基线为 2.0.0，采用 A「清爽青柠」＋01「纯白通透」与商品包裹 / YJ SVG；详见 [2026-09-05 已接受更新记录](./07-lime-white-brand-refresh.md)。这是设计基线的 major 更新，未改动章节保持原有规则与各自版本，不代表活跃应用或接口版本同步升级。
