...
- 是否有硬编码颜色/字号/间距？
- 是否兼容亮色/暗色？
- 亮色背景、导航和卡片是否保持纯白，靠留白、间距与细中性边框分层？
- 是否避免整页或整个业务区块铺灰底、浅绿底？
- 青柠实色按钮在默认、hover、pressed 状态是否始终使用石墨文字和图标？
- 暗色是否使用中性石墨层级，未沿用绿色暗底？
- Logo 是否引用当前 SVG，亮暗环境和小尺寸是否正确？
- 状态、风险、图表是否保持独立语义并辅以文字/图形？
- 图标是否来自 registry？
