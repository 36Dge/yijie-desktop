...
export interface NativeConversationHistory {
  /**
   * @maxItems 50
   */
  views: NativeConversationView[];
  historyAvailability: "partial" | "unavailable";
  /**
   * @maxItems 50
   */
  submissions: LocalSubmissionView[];
  /**
   * @maxItems 50
   */
...
export interface LocalSubmissionView {
  turnId: string;
  operationId: string;
