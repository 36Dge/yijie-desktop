...
export function createNaiveThemeOverrides(
  ...
  return {
    ...
    Button: {
      borderRadiusTiny: token('--yj-radius-md'),
      borderRadiusSmall: token('--yj-radius-md'),
      borderRadiusMedium: token('--yj-radius-md'),
      borderRadiusLarge: token('--yj-radius-md'),
      heightTiny: token('--yj-control-height-sm'),
      heightSmall: token('--yj-control-height-sm'),
      heightMedium: token('--yj-control-height-md'),
      heightLarge: token('--yj-control-height-lg'),
      fontSizeTiny: token('--yj-font-size-body'),
      fontSizeSmall: token('--yj-font-size-body'),
      fontSizeMedium: token('--yj-font-size-body'),
      fontSizeLarge: token('--yj-font-size-body'),
      paddingTiny: `0 ${token('--yj-space-3')}`,
      paddingSmall: `0 ${token('--yj-space-3')}`,
      paddingMedium: `0 ${token('--yj-space-4')}`,
      paddingLarge: `0 ${token('--yj-space-4')}`,
      iconSizeTiny: token('--yj-space-4'),
      iconSizeSmall: token('--yj-space-4'),
      iconSizeMedium: token('--yj-space-4'),
      iconSizeLarge: token('--yj-space-5'),
      fontWeight: '500',
    ...
    Tag: {
      ...
      heightTiny: token('--yj-badge-height'),
      heightSmall: token('--yj-badge-height'),
      heightMedium: token('--yj-badge-height'),
      heightLarge: token('--yj-badge-height'),
      padding: `0 ${token('--yj-space-2')}`,
      fontSizeTiny: token('--yj-font-size-caption'),
      fontSizeSmall: token('--yj-font-size-caption'),
      fontSizeMedium: token('--yj-font-size-caption'),
      fontSizeLarge: token('--yj-font-size-caption'),
      color: surface,
