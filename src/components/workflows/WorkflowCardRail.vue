...
@container workflow-page (min-width: 1120px) { .workflow-card-rail__list { --visible-cards: 4; } }
@container workflow-page (max-width: 600px) { .workflow-card-rail__list { --visible-cards: 1; } }
