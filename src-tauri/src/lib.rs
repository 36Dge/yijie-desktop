...
pub fn run() {
    ...
    let builder = builder.invoke_handler(tauri::generate_handler![
        ...
        chat::schedules::ipc_commands_generated::schedule_save_active_plan_v1,
        chat::schedules::ipc_commands_generated::schedule_confirm_active_draft_v1,
        chat::schedules::ipc_commands_generated::schedule_enable_plan_v1,
        ...
        chat::ipc::chat_get_permissions_v1,
        chat::ipc::chat_set_permissions_v1,
        chat::ipc::chat_runtime_approvals_v1,
        chat::ipc::chat_runtime_approvals_v2,
        chat::ipc::chat_decide_runtime_approval_v1,
        chat::ipc::chat_decide_runtime_approval_v2,
