...
const CONTRACTS_COMMIT = "3832a6c5e99b2a6365f193280fdb887c8fdbc2de";
const HOST_REPOSITORY = "https://github.com/36Dge/yijie-agent-host.git";
const HOST_COMMIT = "b9358f06f3a15aa17a2471cf0bb8bfd0e2b29bfe";
const SOURCE_PINS = Object.freeze({
  openapi: [
    "openapi/agent-host/agent-host.yaml",
    "49e2171e41e0fc11313a114c82ff09e11a0df396e4b366a03b0d7e3afe1766df",
  ],
  event_schema: [
...
const HOST_SOURCE_PINS = Object.freeze({
  ...
  generated_openapi: [
    ...
    "cc6948f3945a953d8c00d602afdf8ba80ccbfaf1e0180fbb7f310fd53bde8b30",
  ],
});
...
const HOST_LOCK_PIN = Object.freeze([
  "api/contracts.lock",
  "c1ae8d7d363269c29a1858142c07a1c6041d9fbd394c126539e12dee767934d9",
]);
...
export function validateRuntimeProjection(projection) {
  if (
    projection?.contracts_version !== "0.6.0" ||
    ...
    JSON.stringify(projection?.host_projection?.runtime_notifications) !==
...
export function validateStableActivation(packageJson, runnerSource, activation) {
  ...
  if (!buildCommand.includes(`env -u ${activation.runtime_flag} -u ${activation.compile_flag}`)) {
    throw new Error("FEAT-134 stable build does not clear ambient activation before its exact compile flag");
  }
  if (
    ...
    throw new Error("FEAT-134 runtime flag may be injected only by the stable launcher");
  }
  for (const [name, command] of Object.entries(scripts)) {
    ...
    if (
      ...
      throw new Error(`non-stable package entry ${name} injects a FEAT-134 flag`);
    }
  }
  ...
  if (
    ...
    throw new Error("FEAT-134 flags are not isolated to exact local/demo_fast/stable launch");
  }
}
